...
class OpCacheService
{
    ...
    public static function init($options = [])
    {
        ...
        if (!empty($_SERVER['HTTP_X_REQUESTED_WITH'])
            ...
            $self->resetCache();
            header('Location: index.php?task=view-opcache');
            exit;
        } else if (isset($_GET['invalidate']) && $self->getOption('allow_invalidate')) {
...
<header>
    <nav>
        <ul>
            ...
            <li><a href="index.php?task=view-opcache&reset=1" id="resetCache" onclick="return confirm('Are you sure you want to reset the cache?');">Reset cache</a></li>
            <?php endif; ?>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        function updateStatus() {
            ...
            $.ajax({
                url: "/index.php?task=view-opcache",
                dataType: "json",
                cache: false,
